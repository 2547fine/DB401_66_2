...
import 'package:tictactoe/models/tile.dart';
...
class _GameState extends State<Game> {
  ...
  bool _winByColumn() {
    for (var col = 0; col < 3; col++) {
      var players = <String>{
        for (var row in [0, 1, 2]) _filled[row][col]
      };
      if (players.length == 1 && players.first == _symbol) {
        return true;
      }
